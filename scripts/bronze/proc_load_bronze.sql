...
Script Purpose:
    ...
    - Truncates the bronze tables beore loading data.
...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '>> Load Duratioon: ' + CAST(DATEDIFF(second, @start_time, @end_time) AS NVARCHAR) + 'seconds'
		PRINT '-----------------'
		...
		PRINT '==========================================='
		PRINT 'Loading Bronze Layer is Completeed';
		PRINT '		- Total Load Duration: '  + CAST(DATEDIFF(SECOND, @batch_start_time, @batch_end_time) AS NVARCHAR) + ' seconds';
		PRINT '==========================================='
		END TRY
		BEGIN CATCH
			PRINT '============================================================================'
			PRINT 'ERROR OCCURED DURING LOADNIG BRONZE LAYER'
